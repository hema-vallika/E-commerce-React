    ...
    <div className="container mx-auto py-8 min-h-96 px-4 md:px-16 lg:px-24">
      {cart.products.length > 0 ? (
        <div>
          ...
          <div className="flex flex-col md:flex-row justify-between space-x-10 mt-8">
            ...
            <div className="md:w-1/3 bg-white p-6 rounded-lg shadow-md border">
              ...
              <button
                className="w-full bg-red-600 text-white py-2 rounded-lg hover:bg-white hover:text-red-600 hover:font-bold hover:border-red-700 hover:border 
        ...
        <div className="flex justify-center">
          <img
            src="https://static6.depositphotos.com/1064545/664/i/950/depositphotos_6648859-stock-photo-man-pushing-a-shopping-cart.jpg"
            alt=""
            className="h-96"
          />
        </div>
