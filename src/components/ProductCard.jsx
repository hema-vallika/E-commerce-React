  ...
  return (
    <Link to={`/product/${product.id}`}>
      <div className=" bg-white p-4 shadow rounded-md relative border transform transition-transform duration-300 hover:scale-100">
        ...
        <div
          class="absolute bottom-4 right-2 flex items-center justify-center w-8 h-8 bg-red-600 group text-white text-sm rounded-full hover:w-32 hover:bg-red-700 transition-all "
